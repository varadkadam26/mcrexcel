...
router.post('/admin/approve-donation', adminController.requireAuth, adminController.approveDonation);
router.post('/admin/clear-all-data', adminController.requireAuth, adminController.clearAllData);
